...
if ($copy -like "Y"){
 ...
 if ($copy -like "N"){
    ...
    Add-Type -AssemblyName 'System.Web' #these three lines generate random 20 character passwords, and only works in Powershell 5.1; not 7
...
#this function will generate the password in Powershell 7
$symbols = '!@#$%^&*'.ToCharArray()
